...
dnl This is the test form Gtk2. I've swapped two branches of an if-statement
dnl because Solaris didn't like the ! for some reason.
...
AC_DEFUN(PKG_CHECK_MODULES, [
  ...
  if test "$PKG_CONFIG" = "no" ; then
     ...
     if $PKG_CONFIG --atleast-pkgconfig-version 0.7.0; then
        ...
        echo "*** Your version of pkg-config is too old. You need version 0.7.0
or newer."
