-- -*-haskell-*-
--  GIMP Toolkit (GTK) @entry Widget SpinButton@
--
--  Author : Axel Simon
--          
--  Created: 23 May 2001
...
-- @constructor spinButtonNew@ Create a new SpinButton.
--
-- * @ref arg climbRate@ is the amount by which the value is changed each time
--   the up/down buttons are pressed.
--
-- * @ref arg digits@ is the number of shown digits. Set to 0 to work with
--   integer values.
--
...
-- @method spinButtonNewWithRange@ Create a new SpinButton with a restricted
-- range.
--
...
-- @method spinButtonConfigure@ Change the settings of a SpinButton.
--
...
-- @method spinButtonSetAdjustment@ Attach a new Adjustment object to the
-- SpinButton.
--
...
-- @method spinButtonGetAdjustment@ Retrieve the Adjustment object that is
...
-- @method spinButtonSetDigits@ Sets the number of shown digits.
--
...
-- @method spinButtonSetIncrements@ Sets the increment for up/down buttons.
--
...
-- @method spinButtonSetRange@ Set the maximal allowable range for the
-- spinbutton.
--
...
-- @method spinButtonGetValue@ Retrieve the current value as a floating point
-- value.
--
...
-- @method spinButtonGetValueAsInt@ Retrieve the current value as integral
-- value.
--
...
-- @method spinButtonSetValue@ Set the value of the SpinButton.
--
...
-- @method spinButtonSetUpdatePolicy@ Whether the an out-of-range value set by
-- @ref method spinButtonSetValue@ is clamped to the limits or simply ignored.
--
...
-- @method spinButtonSetNumeric@ Sets the flag that determines if non-numeric
...
-- @method spinButtonSpin@ Increment or decrement the current value of the
-- SpinButton.
--
...
-- @method spinButtonSetWrap@ Sets the flag that determines if a spin button
...
-- @method spinButtonSetSnapToTicks@ Sets the policy as to whether values are
...
-- @method spinButtonUpdate@ Force an update of the SpinButton.
--
...
-- @signal connectToInput@ Install a custom input handler.
--
...
-- @signal connectToOutput@ Install a custom output handler.
--
...
-- @signal connectToValueSpinned@ The value of the spin button has changed.
--
